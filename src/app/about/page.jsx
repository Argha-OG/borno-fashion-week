          ...
          >
            <div className="space-y-4">
              <h2 className="text-3xl font-bold text-white tracking-tight">
                The OneMediaGroup Vision
              </h2>
              <p className="text-white/60 text-lg leading-relaxed">
                Organized by OneMediaGroup, Borneo Fashion Week has established
                itself as the premier fashion event in the region. Our journey
                began with a simple mission: to showcase the untamed creativity
                of Borneo and provide a world-class platform for designers
            ...
            <div className="space-y-4">
              ...
              <p className="text-white/60 text-lg leading-relaxed">
                To serve as a strategic launchpad for emerging and established
                ASEAN designers, fostering connections with international
                buyers, media, and creative talents while celebrating the rich
                cultural tapestry of the Borneo heritage.
              </p>
            </div>

            <div className="glassmorphism p-8 rounded-3xl border-gold/10">
              <p className="text-white italic text-xl font-light">
                "We don't just host a runway; we celebrate the pulse of ASEAN
                fashion."
              </p>
            </div>
          </motion.div>
      ...
      <section className="py-20 bg-white/5 border-y border-white/5 px-4">
        <div className="max-w-7xl mx-auto text-center mb-16">
          ...
          <p className="text-white/40 max-w-2xl mx-auto">
            Explore the vibrant heritage of Borneo interwoven with high-fashion
            sophistication.
          </p>
        </div>
