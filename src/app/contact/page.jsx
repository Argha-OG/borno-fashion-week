        ...
        >
          <div className="space-y-6">
            ...
            <p className="text-white/60 leading-relaxed text-lg">
              Whether you are a designer, a sponsor, or a media partner, we are
              ready to discuss how you can be part of Borneo Fashion Week.
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="flex items-start space-x-6 group">
              ...
              <div>
                <h4 className="text-white/40 text-xs uppercase tracking-widest mb-1">
                  Email Us
                </h4>
                <a
          ...
          <div className="pt-12 border-t border-white/10">
            ...
            <div className="flex space-x-6">
              <Link
                href="https://www.instagram.com/borneofashionweek26/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-3 text-white/60 hover:text-gold transition-colors"
              >
                <Instagram size={20} />
                <span>Instagram</span>
              </Link>
              <Link
                href="https://www.facebook.com/BFW2019"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-3 text-white/60 hover:text-gold transition-colors"
              >
            ...
            {submitted ? (
              <div className="py-20 text-center space-y-6">
                ...
                <p className="text-white/60">
                  Our team will contact you within 24-48 hours. Thank you for
                  reaching out to Borneo Fashion Week.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-[0.2em] text-white/60 font-bold ml-4">
                    Full Name
                  </label>
                  <input
                    type="text"
